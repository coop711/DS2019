...
kable(t(table(cut(cell_numbers, 
                  labels = cut_label, 
                  breaks = seq(1000, 10000, by = 1000)))), align = "c")
hist(cell_numbers)
```
...
```{r, colleges}
# set.seed(1)
kable(class_roll[sample(1:nrow(class_roll), size = 8), ], align = "c")
```
