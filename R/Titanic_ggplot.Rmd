...
#                            ggtitle = "객실 등급별 생존/사망",
  ...
  theme(plot.title = element_text(hjust = 0.5))
top1 <- textGrob("객실 등급별 생존/사망", gp = gpar(cex = 1.2, fontfamily = "KoPubWorldDotum Bold"))
...
#                            ggtitle = "객실 등급별 생존/사망",
  ...
  scale_fill_manual(name = "", labels = c("생존", "사망"), values = rainbow(2)[2:1]) +
  theme(plot.title = element_text(hjust = 0.5))
top2 <- textGrob("남녀별 생존/사망", gp = gpar(cex = 1.2, fontfamily = "KoPubWorldDotum Bold"))
...
#                            ggtitle = "객실 등급별 생존/사망",
  ...
  scale_fill_manual(name = "", labels = c("생존", "사망"), values = rainbow(2)[2:1]) +
  theme(plot.title = element_text(hjust = 0.5))
top3 <- textGrob("어린이와 어른의 생존/사망", gp = gpar(cex = 1.2, fontfamily = "KoPubWorldDotum Bold"))
...
#                            ggtitle = "객실 등급별 생존/사망",
  ...
  scale_fill_manual(name = "", labels = c("생존", "사망"), values = rainbow(2)[2:1]) +
  theme(plot.title = element_text(hjust = 0.5))
top4 <- textGrob("객실 등급별 여성 생존/사망", gp = gpar(cex = 1.2, fontfamily = "KoPubWorldDotum Bold"))
...
#                            ggtitle = "객실 등급별 생존/사망",
  ...
  scale_fill_manual(name = "", labels = c("생존", "사망"), values = rainbow(2)[2:1]) +
  theme(plot.title = element_text(hjust = 0.5))
top5 <- textGrob("객실 등급별 어린이 생존/사망", gp = gpar(cex = 1.2, fontfamily = "KoPubWorldDotum Bold"))
